...
const Newcashbackcard = () => {
    return (
        <div className='w-auto h-auto grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 px-20'>
            ...
            {/* Item 2 - Door services (adjusted position) */}
            <div className="flex flex-col items-center justify-between h-full py-4">
                <div className='text-[#e22f2f] flex items-center justify-center'>
                    <img src={t.src} className='w-36 h-36 object-contain' />
                </div>
                <p className='w-60 text-center text-xl pt-4 font-bold -mt-2'>Door services</p> {/* Adjusted upwards */}
            </div>

            {/* Item 3 - Pledge gold takeover (adjusted position) */}
            <div className="flex flex-col items-center justify-between h-full py-4">
                <div className='text-[#e22f2f] flex items-center justify-center'>
                    <img src={th.src} className='w-36 h-36 object-contain' />
                </div>
                <p className='w-60 text-center text-xl pt-4 font-bold -mt-2'>Pledge gold takeover</p> {/* Adjusted upwards */}
            </div>
