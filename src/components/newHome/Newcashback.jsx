      ...
      <div className={`w-auto h-auto bg-white py-5 md:py-16 transform transition-all duration-300 
        ...
        <div className='grid grid-cols-1 md:grid-cols-3'>
          <div className='px-10 md:px-6 lg:px-10 pt-14 text-center md:text-start'>
            <h1 className='text-[#efbf04] text-3xl md:text-base lg:text-3xl '>Max Golds History Since - 2006</h1>
            <p className='pt-5 text-2xl text-black md:text-xl lg:text-2xl md:!leading-8'>We are the best choice for you to sell your precious gold jewelry and get instant cash.</p>
          </div>
          ...
          <div className='pt-10 md:pt-14 text-center md:text-start px-10 md:px-6 lg:px-10'>
            ...
            <a href="#_" className="rounded py-3 px-8 overflow-hidden group bg-[#550000] relative hover:bg-gradient-to-r hover:from-red-700 hover:to-red-500 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-700 transition-all ease-out duration-300">
