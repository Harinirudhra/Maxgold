    ...
    return (
      ...
      <div className='grid grid-cols-1 md:grid-cols-3'>
        <div className='px-10 md:px-6 lg:px-10 pt-14 text-center md:text-start'>
          <h1 className='text-[#efbf04] text-xl md:text-base lg:text-3xl'>Max Gold’s History Since - 2006</h1>
        ...
        <button className="bg-[#550000] text-white mt-5 py-3 px-8 rounded-lg hover:bg-red-700 transition-all duration-300">
          Contact
        </button>
