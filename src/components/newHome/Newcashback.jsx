    ...
    <div className='w-auto h-auto py-5 md:py-16'>
      <div className='grid grid-cols-1 md:grid-cols-3'>
        ...
        <div className='pt-10 md:pt-14 text-center md:text-start px-10 md:px-6 lg:px-10'>
          ...
          <a href="#_" class="rounded py-3 px-8 overflow-hidden group bg-[#550000] relative hover:bg-gradient-to-r hover:from-red-700 hover:to-red-500 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-700 transition-all ease-out duration-300">
