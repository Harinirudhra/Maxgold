  ...
  return (
    <div className="py-10 px-4 lg:px-8">
      <header className="text-center">
        <h1 className="font-bold md:text-3xl text-xl mb-3">Max Gold - Our Locations</h1>
      ...
      {contactData.locations.map(({ name, address, email, phone, mapUrl, backgroundColor }, index) => (
        <div 
