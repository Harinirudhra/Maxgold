...
import bgz from '../../../public/RKImages/ramyabout.jpg'
        ...
        <div className="container mx-auto">
          <div className={`flex flex-col gap-6 md:flex-row  mx-auto items-center transform transition-all duration-700 ${scrolling ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            <div className="md:w-1/2 pb-5 text-blue-50 ">
              ...
              <p className="mb-4 text-xl p-4">MaxGold started in year 1990 and in a short span of time has 1000s of happy customers in our list, growing by word of mouth advertising through customers who have used our services. We are leading cash for gold buyers in Chennai.</p>
              ...
              <a href="#_" className="relative rounded px-5 py-2.5 overflow-hidden group bg-yellow-500 hover:bg-gradient-to-r hover:bg-yellow-300 text-black hover:ring-2 hover:ring-offset-2 hover:ring-yellow-500 transition-all ease-out duration-300 ml-4">
                <span className="relative">Contact</span>
              </a>
            </div>
            <div className={`md:w-1/2  md:mb-0 text-center flex items-center jus transform transition-all duration-700 ${scrolling ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
              <Image
                id="designups-symbol"
                src={bgz}
