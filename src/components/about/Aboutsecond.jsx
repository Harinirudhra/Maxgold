      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-6 md:flex-row max-w-screen-lg mx-auto items-center">
          ...
          <div className="md:w-2/3 md:ml-8 text-blue-50">
            ...
            <a href="#_" class="relative rounded px-5 py-2.5 overflow-hidden group bg-white hover:bg-gradient-to-r hover:bg-white text-black hover:ring-2 hover:ring-offset-2 hover:ring-yellow-500 transition-all ease-out duration-300 ml-4">
