    ...
    <div className="container mx-auto">
      <div className="flex flex-col gap-6 md:flex-row max-w-screen-lg mx-auto items-center">
        ...
        <div className="md:w-2/3 md:ml-8 text-blue-50">
          ...
          <p className="mb-4">MaxGold started in year 2006 and in short span of time 1000s of Happy customers in our list & keeps growing by word of mouth advertisment through customers who used our services.We are leading cash for gold buyers in chennai</p>
