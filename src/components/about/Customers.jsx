...
<div className="flex items-center justify-center gap-x-1 p-6 sm:p-10 md:p-12 lg:p-16 xl:p-20 bg-rose-300 sm:bg-white md:bg-rose-300 lg:bg-rose-300 xl:bg-rose-300">
