...
const DoorstepY = () => {
    ...
    return (
        <div class="max-w-4xl mx-auto px-5 pb-10">

            <div className="text-center">
                <p className="font-semibold text-yellow-400 text-3xl">
                    Max Golds doorstep services offer several advantages that set us apart
                </p>
            ...
            <div class="grid md:grid-cols-2 gap-10 mt-10">
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-xl">Expertise and Professionalism</h3>
                        <p class="mt-1 text-gray-500">
                            Our team of expert appraisers ensures that you receive a fair and competitive price for your gold items. Their expertise guarantees the accuracy of the valuation.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-xl">Transparent Pricing</h3>
                        <p class="mt-1 text-gray-500">

                            We provide transparent pricing, ensuring you understand how the price is determined and any associated fees before proceeding with the transaction.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-xl">Security and Privacy</h3>
                        <p class="mt-1 text-gray-500">The security of your gold items and your personal information is our top priority. We have comprehensive security measures in place to safeguard your assets and data.</p>
                    </div>
                </div>
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-xl">Local Accessibility</h3>
                        <p class="mt-1 text-gray-500">  Max Gold is strategically located, making it easy for you to access our doorstep services. Our local presence adds to the simplicity and convenience of the transaction.</p>
                    </div>
                </div>
                ...
                <div class="flex gap-4 items-start">
                    ...
                    <div>
                        <h3 class="font-semibold text-xl">Commitment to Customer Satisfaction</h3>
                        <p class="mt-1 text-gray-500">
                            At Max Gold, customer satisfaction is our top priority. Our dedicated team strives to provide exceptional service, ensuring your experience with us is both profitable and satisfying.                </p>
                    </div>
                </div>
