...
const DoorstepX = () => {
    const services = [
        {
          title: "Time-Saving",
          text: "With doorstep services, you save valuable time. There’s no need to commute, find parking, or wait in queues. Our team comes to you, ensuring that the transaction is efficient and swift."
        },
        {
          title: "Safety and Security",
          text: "Selling valuable gold items can be a concern for safety. Max Gold’s doorstep services are designed with your security in mind. Our trained professionals handle your gold with the utmost care and professionalism, ensuring a secure transaction."
        },
        {
          title: "Flexibility",
        ...
        },
        {
          ...
          text: "Max Gold’s team of expert appraisers, who are trained to assess the value of your gold accurately, accompany our doorstep services. You can have confidence that you’ll receive a competitive and fair valuation for your gold items."
        }
      ];
    ...
    <div className=" px-4 py-8 min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        ...
        <h1 className='text-left text-yellow-400'>
          Max Gold’s Convenient Doorstep Services: Sell Your Gold, Your Convenience
        </h1>
        <p className=' text-left mt-3 '>
        Max Gold makes selling your gold simple with our trusted doorstep service. Whether it’s jewelry, coins, or other gold items, our experts come directly to you, ensuring a secure, hassle-free process. From valuation to payment, everything is handled at your convenience, allowing you to unlock the value of your gold without leaving home.
        </p>
        </div>
        <div className="mt-12 text-black ">
        <h1 className=' text-left text-yellow-400'>
