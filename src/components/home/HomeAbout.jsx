...
<div class="flex flex-col sm:flex-row md:flex-row items-center sm:items-start sm:px-5 md:px-10 lg:px-20 ">
  ...
  <div class="ml-0 sm:ml-5 md:ml-3 lg:ml-10 pr-5 pt-3 md:pr-0 lg:pr-2 mt-0 sm:mt-0 md:mt-0  sm:w-1/2 md:w-1/2 p-5">
    ...
    <p class="mt-9 text-gray-500 text-justify md:mt-1 lg:mt-5 xl:mt-9">
    ...
    <button class="mt-5 text-gray-500 text-sm border rounded-3xl border-red-500 p-2 px-7 hover:bg-red-500 hover:text-white transition duration-300 md:mt-1 lg:mt-3">
      Read More
    </button>
  </div>
</div>
...
<div class="flex flex-col md:flex-row gap-x-7 gap-y-10 sm:ml-10 p-5 md:ml-10 mr-7 mt-10 mb-10 lg:ml-20">
  <div class="text-sm w-full sm:w-[300px] md:w-[390px]">
    ...
    <h3 class="text-sm pt-1">Наша команда состоит из высококлассных<br></br>fспециалистов с международным опытом...</h3>
  </div>

  <div class="text-sm w-full sm:w-[300px] md:w-[390px]">
    <p class="text-red-500">Marketing</p>
    <h1 class="font-bold pt-1">How to pretend you know something<br></br>fyou really don't</h1>
    <h3 class="text-sm pt-1">Наша команда состоит из высококлассных<br></br>fспециалистов с международным опытом...</h3>
  </div>

  <div class="text-sm w-full sm:w-[300px] md:w-[390px]">
    <p class="text-red-500">Development</p>
    <h1 class="font-bold pt-1">What software is our favorite and <br></br>fwhy</h1>
    <h3 class="text-sm pt-1">Наша команда состоит из высококлассных<br></br>fспециалистов с международным опытом...</h3>
  </div>
</div>
